...
int main(int argc, char *argv[]) {
  ...
  // ora calcolo la media cumulativa, sommando in progressione il contributo di
  // ogni blocco
  for (int i = 0; i < N; i++) { // per ogni blocco
    ...
    err_prog[i] = error(sum_prog, su2_prog,
              i); // Deviazione standard calcolata fino al blocco i-esimo
